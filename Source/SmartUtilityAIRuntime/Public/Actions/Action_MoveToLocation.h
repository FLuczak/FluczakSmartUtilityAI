...
#include "Action_MoveToLocation.generated.h"

UCLASS(BlueprintType, Blueprintable, EditInlineNew, DefaultToInstanced, meta = (DisplayName = "Move To Location"))
class SMARTUTILITYAIRUNTIME_API UAction_MoveToLocation : public UUtilityActionBase
{
	GENERATED_BODY()
...
private:
	bool ResolveLocation(const class UUtilityBrainComponent &OwnerComp, FVector &OutLocation) const;
};
