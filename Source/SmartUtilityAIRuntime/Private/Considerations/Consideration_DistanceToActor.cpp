...
#include "Considerations/Consideration_DistanceToActor.h"
...
UConsideration_DistanceToActor::UConsideration_DistanceToActor()
{
	InputMin = 0.f;
	InputMax = 2000.f;
}
...
#if WITH_EDITOR
FText UConsideration_DistanceToActor::GetExtraDescription() const
{
...
float UConsideration_DistanceToActor::ComputeRawValue(const UUtilityBrainComponent &OwnerComp, APawn *ControlledPawn) const
{
